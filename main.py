...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'vanshdubey22@gmail.com' ")
...
lbl.place(x=180, y=55)

txt = tk.Entry(frame2,width=53 ,fg="black",font=('times', 15, ' bold '))
txt.place(x=50, y=88)

lbl2 = tk.Label(frame2, text="Enter Name",width=20  ,fg="black"  ,bg="#00aeff" ,font=('times', 17, ' bold '))
lbl2.place(x=180, y=140)

txt2 = tk.Entry(frame2,width=53 ,fg="black",font=('times', 15, ' bold ')  )
...
lbl3 = tk.Label(frame1, text="Attendance",width=20  ,fg="black"  ,bg="#00aeff"  ,height=1 ,font=('times', 22, ' bold '))
lbl3.place(x=160, y=115)
...
tv.grid(row=2,column=0,padx=(65,0),pady=(150,0),columnspan=4)
...
clearButton2.place(x=480, y=172)    
